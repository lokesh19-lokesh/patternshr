  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        {/* Auth CTA Actions (Keka Style) */}
        <div className="hidden sm:flex items-center space-x-3 text-xs font-bold">
          <Link
            to="/login"
            className="px-4 py-2.5 text-slate-700 hover:text-slate-950 font-bold hover:bg-slate-100 rounded-xl transition-all"
          >
            Log In
          </Link>
          ...
          <Link
            to="/signup"
            className="px-5 py-2.5 bg-primary-green hover:bg-dark-green text-white rounded-xl shadow-md shadow-emerald-900/20 flex items-center space-x-1.5 transition-all hover:scale-105"
          >
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-b border-slate-200 px-4 pt-3 pb-6 space-y-3 animate-fade-in text-sm font-bold text-slate-700">
          <a
            href="#services"
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-col space-y-2">
            <Link
              to="/login"
              className="w-full py-2.5 text-center text-slate-700 hover:bg-slate-100 rounded-xl"
            >
              Log In
            </Link>
            <Link
              to="/signup"
              className="w-full py-3 text-center bg-primary-green text-white font-bold rounded-xl shadow-md flex items-center justify-center space-x-1.5"
            >
              <span>Start Free Trial</span>
